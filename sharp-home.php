...
<body>
   ...
   <!--Header Here-->
   <header class="header-section home__header border__bottom sharp__header">
      <div class="container">
   ...
   <!--Banner Start-->
   <section class="home__section sharp__home">
            ...
            <div class="row align-items-center justify-content-between flex-lg-row-reverse">
               <div class="col-xl-6 col-lg-6">
                  <div class="home__content">
                     ...
                     <h6>
                        <span class="text-base">Atos</span> Commanded
                     </h6>
                     <h2>
                        All in Shared Hosting and very very <span class="home__theme">useful Pakges</span> hosting
                     </h2>
                     <p>
                        We hope our hosting will be very useful for you and you can use this hosting in all kinds of
                        ways. Do you have more hosting we are always with you.
                     </p>
                     <div class="btn__grp">
                        <a href="#0" class="cmn--btn border__trans">
                           <span>Get Hosting For Your</span>
                        </a>
                     </div>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6">
                  <div class="home__thumb">
                     <img src="assets/img/sharp-home/circles.png" alt="home">
                  </div>
               </div>
            </div>
         </div>
   ...
   <section class="home__domain pb-80">
      <div class="container">
   ...
   <!--Feature Here-->
   <section class="home__feature sharp__feature pb-80">
      <div class="container">
         <div class="domain__head section-center">
            <h4 class="text-white wow fadeInDown" data-wow-delay="0.2s">
               A web hosting company that stands by your side in a <span class="text-base">powerful</span> hosting
            </h4>
            ...
            <div class="row g-4">
               <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-sm-6">
                  <div class="home__feature__items">
                     <div class="thumb">
                        <img src="assets/img/sharp-home/feature/secure.png" alt="f">
                     </div>
                     <h6>
                        <a href="#0">
                           Total Secure
                     ...
                     <p>
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illum modi its.
                     </p>
                  </div>
               </div>
               <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-sm-6">
                  <div class="home__feature__items">
                     <div class="thumb">
                        <img src="assets/img/sharp-home/feature/space.png" alt="f">
                     </div>
                     <h6>
                        <a href="#0">
                           Great Specs
               ...
               <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-sm-6">
                  <div class="home__feature__items">
                     <div class="thumb">
                        <img src="assets/img/sharp-home/feature/fast.png" alt="f">
                     </div>
                     <h6>
                        <a href="#0">
                           Fast Respond
               ...
               <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-sm-6">
                  <div class="home__feature__items">
                     <div class="thumb">
                        <img src="assets/img/sharp-home/feature/support.png" alt="f">
                     </div>
                     <h6>
                        <a href="#0">
                           100% Support
   ...
   <section class="pricing__sharp pb-120">
      <div class="container">
         <div class="section__header section-center">
            <h4 class="text-white wow fadeInDown" data-wow-delay="0.2s">
               We have the perfect web <span class="text-base">Hosting</span> package for you interest in package
            </h4>
         </div>
   ...
   <!--Home Pricing Here-->
   <section class="home__pricing consulting__home pb-120">
      <div class="container">
         <div class="row g-4 align-items-center">
            <div class="col-xl-6 col-lg-6">
   ...
   <!--Home Product Here-->
   <section class="home__product sharp__product pb-120">
      <div class="container">
         <div class="domain__head mb-4">
            <h4 class="text-white wow fadeInDown" data-wow-delay="0.2s">
               We Provide you World <span class="text-base">Hosting</span> Services.
            </h4>
         </div>
         <div class="row g-4">
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
               <div class="home__product__items">
                  ...
                  <div class="review__wrap">
                     <div class="left__ratting">
                        <div class="icon">
                           <img src="assets/img/sharp-home/consulting/google.png" alt="google">
                        </div>
                        <div class="ratting">
                           <span><i class="fas fa-star"></i></span>
                           <span><i class="fas fa-star"></i></span>
   ...
   <section class="home__testimonial sharp__testimonial pb-120">
      <div class="container">
         <div class="section__header section-center">
            <h4 class="text-white wow fadeInDown" data-wow-delay="0.2s">
               Hundreds of <span class="text-base">five-star</span> Ratings. Every day!
            </h4>
         </div>
         <div class="home__slide__wrap owl-theme owl-carousel">
            <div class="user__items">
               ...
               <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam, neque quod placeat.
               </p>
            </div>
            <div class="user__items">
               <div class="client">
   ...
   <section class="home__complate__section">
      <div class="container">
         <div class="complate__wrap">
            ...
            <p>
               Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores neque assumenda odio dolore unde minus,
               ipsa iste, atque tempora earum harum ullam in magni est consectetur, voluptatum reprehenderit illo.
            </p>
            <a href="#0" class="cmn--btn border__trans">
               <span>
                  Get Started Now
   ...
   <!--Footer Here-->
   <footer class="footer-section home__footer sharp__footer pt-120">
      <div class="container">
                  ...
                  <div class="widget-items">
                     <div class="footer-head">
                        <a href="index.html" class="footer-logo">
                           <img src="assets/img/logo/logo2.png" alt="f-logo">
                        </a>
                     </div>
