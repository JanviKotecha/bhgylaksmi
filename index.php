...
<head>
   ...
   <title>Bhagya Laxmi Capital</title>
            ...
            <div class="row">
               <div class="col-xl-8 col-lg-8 col-md-8">
                  <div class="banner__content">
                     <h1>
                        Welcome New <span class="text-base"><br>Trader</span>
                     </h1>
                     <p style="font-size:20px">
                        Embark on a journey of endless trading opportunities with our app.
                        Explore markets, access a wide range of financial instruments, and seize potential profits by
                        taking advantage of
      ...
      <div class="container">
         <div class="section__header section-center">
            <h2 class="text-white wow fadeInDown" data-wow-delay="0.2s">
               OUR <span class="text-base">SERVICES</span>
            </h2>
               ...
               <ul class="choose__wrap">
                  <li class="wow fadeInUp" data-wow-delay="0.2s">
                     <div class="content">
                        ...
                        <p>
                           No Hidden Charges For investment services
                        </p>
                     </div>
                     <div class="icon">
                  ...
                  <li class="wow fadeInUp" data-wow-delay="0.4s">
                     <div class="content">
                        ...
                        <p>
                           Intraday Trading And Holding Service Are Available
                        </p>
                     </div>
                     <div class="icon">
                  ...
                  <li class="wow fadeInUp" data-wow-delay="0.6s">
                     <div class="content">
                        ...
                        <p>
                           Daily High Return Profitable Calls & Market Analysis Support
                        </p>
                     </div>
                     <div class="icon">
               ...
               <ul class="choose__wrap choose__wrap__two">
                  <li class="wow fadeInUp" data-wow-delay="0.2s">
                     ...
                     <div class="content">
                        ...
                        <p>
                           Indian Stock Market NSE F&O, Option With Minimum Brg Future BRG (1+1) Options BRG (25+25)
                        </p>
                     </div>
                  </li>
                  <li class="wow fadeInUp" data-wow-delay="0.4s">
                     ...
                     <div class="content">
                        ...
                        <p>
                           Multi Commodity ExchangeMCX BRG 25+25 Lot Buy And Sell
                        </p>
                     </div>
                  </li>
                  <li class="wow fadeInUp" data-wow-delay="0.6s">
                  ...
                  <li class="wow fadeInUp" data-wow-delay="0.6s">
                     ...
                     <div class="content">
                        ...
                        <p>
                           Feature Instant (Deposit & Withdrawal) 24/7 Customer Support
                        </p>
                     </div>
                  </li>
               </ul>
      ...
      <div class="container">
         <div class="section__header section__header__space">
            <h2 class="wow fadeInDown" data-wow-delay="0.2s">
               APP <span class="text-base">FEATURES</span>
            </h2>
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-4">
               <div class="atos__left__wrap">
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                     ...
                     <li class="nav-item" role="presentation">
                        <button class="nav-link" id="Upto-tab" data-bs-toggle="tab" data-bs-target="#Upto" type="button"
                           role="tab" aria-controls="Upto" aria-selected="true">
                           <span class="icon"><i class="fa-solid fa-cloud"></i></span>
                           <span>Upto 500x Levarge On All Trades</span>
                        </button>
                     </li>
                     <li class="nav-item" role="presentation">
                  ...
                  <div class="tab-content" id="myTabContent">
                     <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="atos__body d-flex flex-column align-items-center">
                           <h4>
                              <span class="text-base">Real-Time </span> Market Data
                           </h4>
                           <div class="thumb">
                           ...
                           <div class="content">
                              <p>
                                 Access up-to-date information on stock prices, indices, and market news,
                                 ensuring you stay informed about market trends and opportunities.
                              </p>
                           </div>
                        </div>
                     </div>
                     <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="atos__body d-flex flex-column align-items-center">
                           ...
                           <div class="content">
                              ...
                              <p>
                                 Keep track of your investments in one place, monitor portfolio performance, and gain
                     ...
                     <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        <div class="atos__body d-flex flex-column align-items-center">
                           ...
                           <div class="content">
                              ...
                              <p>
                                 Enjoy the convenience of accessing the app on your smartphone or tablet, allowing you
                                 to
                     ...
                     <div class="tab-pane fade" id="Trading" role="tabpanel" aria-labelledby="Trading-tab">
                        <div class="atos__body d-flex flex-column align-items-center">
                           ...
                           <div class="content">
                              ...
                              <p>
                                 Allow investors to execute trades efficiently, capitalize on market opportunities, and
                     ...
                     <div class="tab-pane fade" id="Upto" role="tabpanel" aria-labelledby="Upto-tab">
                        <div class="atos__body d-flex flex-column align-items-center">
                           ...
                           <div class="content">
                              ...
                              <p>
                                 With up to 500x leverage on trades, traders can potentially magnify their profits
                                 significantly, maximizing returns on investment and taking advantage of market
                                 opportunities.
                              </p>
                     ...
                     <div class="tab-pane fade" id="Transparent" role="tabpanel" aria-labelledby="Transparent-tab">
                        <div class="atos__body d-flex flex-column align-items-center align-items-center">
                           ...
                           <div class="content">
                              <p>We build trust, accountability and credibility. We ensure clear communication, ethical
               ...
               <div class="server__right__wrap owl-theme owl-carousel">
                  <div class="server__items">
                     <div class="calling">
                        ...
                        <p>Download and install our app from your preferred app store, or visit our website service to
                           experience seamless trading...</p>
                     </div>
                  </div>
                  <div class="server__items">
                     <div class="calling">
                        ...
                        <p>
                           Easily create your account by providing necessary information, allowing you to begin trading,
                  ...
                  <div class="server__items">
                     ...
                     <div class="calling">
                        ...
                        <h4>
                           Enjoy Growing Networth
                        </h4>
                        <p>
                           Enjoy the satisfaction of witnessing your net worth grow as you leverage the power of our app
                     ...
                     <div class="row">
                        ...
                        <div class="col-xxl-4 col-xl-2 col-lg-3 col-md-4 col-sm-4 col-xs-6">
                           <div class="spnsor__items">
                              ...
                              <a href="#0">
                                 <h3 class="font">Simple Account  <span style="color:#f8a30c">Setup</span></h3>
                              </a>
                           </div>
                        </div>
                        <div class="col-xxl-4 col-xl-2 col-lg-3 col-md-4 col-sm-4 col-xs-6">
   ...
   <section class="complate__section pt-80 pb-80">
      <div class="container">
         <div class="complate__wrap">
            ...
            <p>
            Download the latest version of our app to access new features, enhanced performance, and a seamless user experience, ensuring you stay up to date with the best trading experience possible.
            </p>
            <a href="#0" >
               <span>
      ...
      <div class="container-fluid">
         ...
         <div class="user__wrap owl-theme owl-carousel">
            <div class="user__items">
               <p>
               I have been doing stock market since long, and it has diversified my growth immensely. I don’t have to invest much time in researching trends, "BHAGYA LAXMI TRADE” do this work very well.
               </p>
            ...
            <div class="user__items">
               <p>
               "BHAGYA LAXMI TRADE” has helped me not only in terms of return but also in understanding market trends and become a better investor with all the insights.
               </p>
            ...
            <div class="user__items">
               <p>
               I have been working with “BHAGYA LAXMI TRADE” and they have helped me gain more knowledge with their risk analysis and projections. Their recommendations are turning profitable for me.
               </p>
